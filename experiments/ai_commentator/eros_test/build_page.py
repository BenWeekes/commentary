"""Results page: Model E EN/zh vs our v7 AI vs the human broadcaster, on the 5-min clip.
...
stats=(f"Model E EN {len(en)} lines · zh-CN {len(zh)} lines · EN gaps (failed translations) {len(en_gaps)}"
...
page=f"""<meta charset=utf-8><title>Model E trial — Mainz vs Union 5-min clip</title>
...
<h2>Model E subtitle test — Mainz vs Union Berlin, 76:50–81:50, 1-1</h2>
...
Model E times are <code>source_pts_ms</code> (the moment described, not arrival). Human = broadcast STT (Soniox); Ours = v7 eager 10s pipeline.</p>
<table><tr><th style="width:46px">t</th><th>Human broadcaster</th><th>Our v7 AI</th><th>Model E EN</th><th>Model E zh-CN</th></tr>
{body}</table>"""
