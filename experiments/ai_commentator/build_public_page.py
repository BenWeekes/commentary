...
PIPELINES = [
    {
        ...
        'fixed_delay_s': 8,
        'internal_variant': 'v20_live',
        'en_mp4': 'v20_live_en_synced.mp4',
        'fr_mp4': 'v20_live_fr_synced.mp4',
        'en_jsonl': 'commentary_v20_live_en_tagged.jsonl',
        'fr_jsonl': 'commentary_v20_live_fr_tagged.jsonl',
