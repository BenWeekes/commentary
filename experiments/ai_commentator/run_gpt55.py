...
OUT_JSONL = BASE / 'commentary_gpt55.jsonl'
OUT_KEPT = BASE / 'commentary_gpt55_kept.txt'
OUT_SCHED = BASE / 'commentary_gpt55_scheduled.jsonl'
...
def main():
    ...
    with open(OUT_KEPT, 'w') as f:
        f.write(f"# AI commentary GPT-5.5 — same v5 pipeline\n# {len(accepted)} accepted of {len(all_attempts)} calls\n# Subs: {subs}\n\n")
