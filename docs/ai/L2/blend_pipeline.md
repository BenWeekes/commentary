...
> [sign_overlay_pipeline.md](sign_overlay_pipeline.md). Vendor commentary ('Model E') pipeline:
> [modelE_pipeline.md](modelE_pipeline.md) (findings history: [eros_vendor_test.md](eros_vendor_test.md)). Companion docs: [hitl_tuning_workflow.md](hitl_tuning_workflow.md)
